...
<body>
	...
	<div class="container">
		...
		<form id="loginForm" class="form-signin" role="form" action="doLogin"
			...
			<div class="form-group has-success has-feedback">
				<%--value="${param.loginacct }" --%>
				<input type="text" class="form-control" id="loginacct"
					name="loginacct" value="superadmin" placeholder="请输入登录账号" autofocus> <span
					class="glyphicon glyphicon-user form-control-feedback"></span>
			</div>
			<div class="form-group has-success has-feedback">
				<input type="password" class="form-control" id="userpswd"
					name="userpswd" value="123456" placeholder="请输入登录密码" style="margin-top: 10px;">
